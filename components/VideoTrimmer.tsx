...
const IconCalculate = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" viewBox="0 0 20 20" fill="currentColor">
        ...
        <path fillRule="evenodd" d="M13.5 3a1.5 1.5 0 00-1.423 1.03l-2.437 6.1a1.5 1.5 0 00.126 1.487l2.06 2.747a1.5 1.5 0 002.348-.123l.107-.179a1.5 1.5 0 00-2.083-2.31L13.5 9.5l1.638-4.1a1.5 1.5 0 00-1.638-1.9z" clipRule="evenodd" />
    </svg>
);


export const VideoTrimmer: React.FC<VideoTrimmerProps> = ({ src, onCalculate, isCalculating }) => {
